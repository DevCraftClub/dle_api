...
-----------------------------------------------------
 http://devcraft.club/
-----------------------------------------------------
 Copyright (c) 2019-2025 Maxim Harder
=====================================================
...
$version = [
	...
	'changelog' => [
		'173.0.39' => [
			'[FIX] Устранена заявленная ошибка с переменной $_SERVER',
			'[UPDATE] маршрут посика был переработан, чтобы можно было искать по нескольким полям'
		],
		'173.0.38' => [
